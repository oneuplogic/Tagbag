...
from settings you can select the posts types you want tagbag to be used with, change the color, change the word count for suggested new tags, add and remove stop words

== Screenshots ==

1. Displaying Tagbag in Standard Color
2. Displaying Tagbag in Red Color
...
= Will the developers of Tagbag continue to improve Tagbag =
